export const HERO_DRAFT_EVENTS = [
  "round:started",
  "round:goldenAnnounced",
  "bidTurn:started",
  "bidTurn:bidPlaced",
  "bidTurn:passed",
  "bidTurn:autoPassed",
  "auction:closed",
  "randomRoll:revealed",
  "randomRoll:insufficientFunds",
  "squadSlot:downgraded",
  "round:completed",
  "draft:completed",
  "tradeWindow:started",
  "tradeWindow:ended",
...
export type HeroDraftEvent = (typeof HERO_DRAFT_EVENTS)[number];
