...
/** Shared market deadline hour in listing timezone (1 = 1 AM). Override with MARKET_DEADLINE_HOUR. */
export const MARKET_DEADLINE_HOUR = parseInt(process.env.MARKET_DEADLINE_HOUR ?? "1", 10);
/** Shared market deadline minute (30 = :30). Override with MARKET_DEADLINE_MINUTE. */
export const MARKET_DEADLINE_MINUTE = parseInt(process.env.MARKET_DEADLINE_MINUTE ?? "30", 10);
