...
export async function GET(
  ...
  try {
    ...
    console.error("Icon boxes GET error:", err);
    return apiError("Failed to load icon boxes", 500);
  }
}
...
export async function POST(
  ...
  try {
    ...
    await emitToRoom(code, "iconbox:updated", { userId: session.userId });
    ...
    console.error("Icon box action error:", err);
